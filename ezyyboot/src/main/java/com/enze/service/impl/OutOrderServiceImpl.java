...
@Service
public class OutOrderServiceImpl implements TaskService<TaskEntity> {

	public static final String key = TeskType.Tesk_Order.getMsg();
	...
	public TaskEntity getTaskActual() {
		TaskEntity taskEntity = (TaskEntity) wmsOutOrderMapper.getTask();
