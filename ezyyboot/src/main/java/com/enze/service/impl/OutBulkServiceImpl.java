...
@Service
public class OutBulkServiceImpl implements TaskService<TaskEntity> {

	public static final String key = TeskType.Tesk_BulkPicking.getMsg();
	...
	public TaskEntity getTaskActual() {
		TaskEntity taskEntity = (TaskEntity) wmsTurnboxMapper.getTask(1);
